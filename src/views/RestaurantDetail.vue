  ...
  <div class="container py-5 px-4">
          ...
          <div class="col-lg-6">
            ...
            <div class="nearby row gy-3">
              <div class="col-sm-4">
                ...
                <span class="mt-1 fs-5 fw-bold">附近景點</span>
              </div>
              <div class="col-sm-4">
                <a href=""></a>
                <img src="../assets/nearby-event30.svg" alt="" width="80px" />
                <span class="mt-1 fs-5 fw-bold">附近活動</span>
              </div>
              <div class="col-sm-4">
                <a href=""></a>
                <img src="../assets/nearby-food30.svg" alt="" width="80px" />
                <span class="mt-1 fs-5 fw-bold">附近美食</span>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
    ...
    <section class="similar-activties">
      <div class="d-flex justify-content-between align-items-end mb-3">
        ...
        <router-link to="/restaurants" class="text-end restaurant-more"
